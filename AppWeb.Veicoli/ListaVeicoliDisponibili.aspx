<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListaVeicoliDisponibili.aspx.cs" Inherits="AppWeb.Veicoli.ListaVeicoliDisponibili" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

      <div class="panel-heading" id="head">
        <h3 class="panel-title">Veicoli Disponibili</h3>
    </div>
